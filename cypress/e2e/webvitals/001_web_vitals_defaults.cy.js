...
// 001_web_vitals_defaults

describe('002 @site @vitals @google @defaults :: on ' + globalValues.DEVICE_TYPE + ' ::  Using cy.vitals() command not using the defaults', function () {
    ...
    it('002 @site @webvitals @google @custom :: on ' + globalValues.DEVICE_TYPE + ' ::  Using cy.vitals() command not using the defaults :: should meet the web-vitals default thresholds', () => {
                cy.vitals({
